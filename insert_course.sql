...
---- select---
select  categories.type as categories, courses.title as nombrecurso, users.name as dictadopor, courses_video.url,  users_courses.id_user  as estudiante,   users_courses.percent_complete, users_courses.complete 
from courses 
